...
$$.main_anon1 = {"":"Closure;userClient_2",
 call$1: function(e) {
  var req, t1;
  $.window().alert$1($.userName);
  $.window().alert$1($.password);
  req = $.HttpRequest_HttpRequest();
  t1 = req.get$on().get$readyStateChange();
  $.getInterceptor$JSArray(t1).add$1(t1, new $.main__anon(req));
  this.userClient_2.send$2($.userName, "fileUpload");
}
};

$$.main__anon = {"":"Closure;req_3",
 call$1: function(e) {
  var t1, t2;
  t1 = this.req_3;
  if ($.eqB(t1.get$readyState(), 4))
    ...
    t2 = false;
  if (t2) {
    $.window().alert$1("test successful");
    $.window().alert$1(t1.get$responseText());
  }
}
};
...
$$.anon0 = {"":"Closure;",
 call$1: function(e) {
  $.window().alert$1("Closed");
}
};

$$.anon1 = {"":"Closure;this_0",
 call$1: function(e) {
  var t1, parsedList, userInput, div, t2, s, t3;
  t1 = e.get$data();
  this.this_0.set$receivedData(t1);
  parsedList = $.JSON_parse(e.get$data());
  userInput = $.query("#uName");
  t1 = e.get$data();
  userInput.set$value($.getInterceptor(t1).toString$0(t1));
  ...
  t2.add$1(s, "<table class=\"table1\">");
  t2.add$1(s, "<thead></thead>");
  t2.add$1(s, "<tr><th >Id</th><th>Robot Name</th><th>X Coordinate</th><th>Y Coordinate</th></tr>");
  for (t1 = $.getInterceptor$JSArray(parsedList).iterator$0(parsedList); t1.get$hasNext() === true;) {
    t3 = t1.next$0();
    $.window().alert$1(t3);
    t2.add$1(s, "<tr><td>" + $.S($.index(t3, 0)) + "</td><td>" + $.S($.index(t3, 1)) + "</td><td>" + $.S($.index(t3, 2)) + "</td></tr>");
  }
  t2.add$1(s, "</table>");
  $.window().alert$1(t2.toString$0(s));
  t1 = div.get$elements();
  $.getInterceptor$JSArray(t1).add$1(t1, $.Element_Element$html(t2.toString$0(s)));
}
};
...
$.main = function() {
  var passwordInput, userInput, t1, userClient;
  ...
  userClient = $.Myworkspace$("ws://127.0.0.1:8080/getUploadedFile");
  t1 = $.query("#login").get$on().get$click();
  $.getInterceptor$JSArray(t1).add$1(t1, new $.main_anon1(userClient));
};
